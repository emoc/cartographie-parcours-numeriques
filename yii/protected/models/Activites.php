 ...
 *
 * The followings are the available columns in table 'activites':
 * @property integer $id
 ...
 */
class Activites extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('activite', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, id_lieu, activite', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Activites the static model class
	 */
