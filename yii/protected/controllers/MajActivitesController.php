...
class MajActivitesController extends Controller
{
	/**
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to ...
				'actions'=>array('createUtil','updateUtil', 'adminUtil', 'delete', 'viewUtil', 'menuActiviteAutocomplete'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to ...
				'actions'=>array('admin','delete','create','view', 'update', 'menuActiviteAutocomplete'),
				'users'=>array('@'),
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Activites'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Activites');
	...
	{
		$model=new Activites('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Activites']))
			$model->attributes=$_GET['Activites'];
	...
	{
		$model=Activites::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Activites $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='activites-form')
		{
	 ...
	 */
	public function actionMenuActiviteAutocomplete()
	{
	    ...
	    if($request!='') {
            ...
            */
            $model=Activites::model()->findAll(array('distinct'=>true, 
                                                     'select'=> 'activite', 
                                                     'order' => 'activite'));
	        $data=array();
            ...
            $databis = array("Initiation informatique",
                             "Vidéo",
                             "Audio",
                             "Développement",
                             "Image",
